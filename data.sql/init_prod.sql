...
(1,'Jahresmitgliedschaft - unser beliebtestes Angebot',365,1,'1 Jahr',29),
(2,'2 Jahre Mitgliedschaft',730,1,'2 Jahre',59),
(3,'5 Jahre Mitgliedschaft',1825,1,'5 Jahre',119),
...
('08dcd23c-d4eb-456b-87e4-73837709fada', 'Holger', 'Admin', '1985-05-15', 'Male', 2, 'admin@alreco.de', 'c5HiLnN1QQ8ES9akWoilpEJ1La5J3jlx85FVHNT6RH8=', 'wITPfLBHFFIWV0TszAKo9UGL8Gnf+CLG4HILeEzQwNA=', 1, 4, 3, 1, 1, 'JBSWY3DPEHPK3PXP', '["12345678", "87654321", "11111111", "22222222", "33333333", "44444444", "55555555", "66666666", "77777777", "88888888"]');
...
-- Insert offers (commented out for production)
...
-- Insert sample pictures (dummy base64 data) (commented out for production)
...
-- Insert sample offer applications (Status: 0=Pending, 1=Approved, 2=Rejected) (commented out for production)
-- Note: No offer applications to avoid Admin User appearing in offer-request

-- Insert sample reviews (mit korrekten User-IDs und Sichtbarkeitslogik) (commented out for production)
...
(1,'Jahresmitgliedschaft - unser beliebtestes Angebot',365,29,'EUR','1 Jahr'),
(2,'2 Jahre Mitgliedschaft',730,59,'EUR','2 Jahre'),
(3,'5 Jahre Mitgliedschaft',1825,119,'EUR','5 Jahre'),
(4,'Lebenslange Mitgliedschaft - einmal zahlen, für immer dabei',9999,299,'EUR','Lebenslang');
...
-- Insert sample transactions (commented out for production)
